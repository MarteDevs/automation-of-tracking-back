...
def test():
    ...
    print(f"Length of full text: {len(texto_completo)}")
    ...
    print(f"Length of sec6 text: {len(texto_sec6)}")
    print(f"Length of sec7_11 text: {len(texto_sec7_11)}")

    print("\n--- FIRST 200 CHARS OF SEC6 ---")
    print(texto_sec6[:200])
    
    print("\n--- LAST 200 CHARS OF SEC6 ---")
    print(texto_sec6[-200:])

    print("\n--- FIRST 200 CHARS OF SEC7_11 ---")
    print(texto_sec7_11[:200])

    print("\n--- LAST 200 CHARS OF SEC7_11 ---")
    print(texto_sec7_11[-200:])
